...
## Acknowledgment
This journal is created to document the learnings of the training workshop conducted by Lakshmi S. and most of the material is sourced from her github profile: https://github.com/lakshmi-sathi/avsdpll_1v8
Some of the initial theory portion and figures are taken from the chapter on Phase-Locked Loop in Behzad Razavi's book titled "Design of Analog CMOS Integrated Circuits".
